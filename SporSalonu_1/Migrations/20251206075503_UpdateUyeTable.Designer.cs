...
namespace SporSalonu_1.Migrations
{
    ...
    [Migration("20251206075503_UpdateUyeTable")]
    partial class UpdateUyeTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SporSalon_1.Models.Antrenor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SporSalon_1.Models.Hizmet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SporSalon_1.Models.Randevu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SporSalon_1.Models.SporSalonu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SporSalon_1.Models.Uye", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SporSalon_1.Models.Uye", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SporSalon_1.Models.Antrenor", b =>
                {
                    b.HasOne("SporSalon_1.Models.SporSalonu", "SporSalonu")
            ...
            modelBuilder.Entity("SporSalon_1.Models.Randevu", b =>
                {
                    b.HasOne("SporSalon_1.Models.Antrenor", "Antrenor")
                        .WithMany("Randevular")
                        .HasForeignKey("AntrenorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SporSalon_1.Models.Hizmet", "Hizmet")
                        .WithMany("Randevular")
                        .HasForeignKey("HizmetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SporSalon_1.Models.Uye", "Uye")
                        .WithMany("Randevular")
                        .HasForeignKey("UyeId");
